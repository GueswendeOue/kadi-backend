...
function passiveCommandRuntimeDependencies(generationRuntime) {
  ...
  return {
    ...
    documentRuntime: {
      start: noop, setInvoiceKind: noop, setReceiptDetails: noop, setClient: noop, startAddContent: noop, addContent: noop, updateContent: noop, removeContent: noop, finishContent: noop,
